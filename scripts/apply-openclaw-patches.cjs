...
/**
 * Apply version-specific Workhorse AI patches to the openclaw source tree.
 *
...
// This removes stale patches left by a different Workhorse AI branch that may have
