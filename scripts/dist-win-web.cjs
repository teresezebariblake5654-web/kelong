...
Modes:
  --pkg-base-url  one-pass build; the installer downloads <dir>/<keyfrom>/Workhorse AI-<version>-x64.nsis.7z
...
if (usesPlaceholder) {
  ...
  console.log(`[WebBuild] next: upload release/Workhorse AI-${version}-x64.nsis.7z, then run`);
