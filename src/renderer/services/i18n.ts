...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    aiSkinCreationGuide: '可前往“专家套件”使用「火星 AI 外观定制」，或直接开始创作。',
    ...
    aiSkinDeleteManagedCopyNote: '只会删除 火星 AI 管理的皮肤副本，不会删除会话中的原始生成图片或卸载 AI 皮肤设计师套件。',
    aiSkinDeleteFailed: '删除皮肤失败，请重试',
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整 火星 AI 界面使用的基准字号',
    codeFontSize: '代码字体大小',
    ...
    shortcutDescNewChat: '开始一个新的 火星 AI 任务',
    shortcutDescFocusPrompt: '跳回 火星 AI 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 火星 AI 任务视图',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。请在设置中配置您自己的 API Key，或联系管理员。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    artifactPreviewCardLobsterBrowser: '火星 AI 浏览器',
    artifactPreviewCardOpenInLobsterBrowser: '在 火星 AI 浏览器中打开',
    ...
    coworkWorkingDirectoryHint: '火星 AI 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 火星 AI 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 火星 AI 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: '火星 AI 使用模型设置中的当前模型与提供商配置。',
    ...
    modelSelectorConfigureTitle: '需要自定义模型',
    modelSelectorConfigureDesc: '请在设置中配置您自己的模型后再继续使用',
    modelSelectorConfigureBtn: '去设置',
    ...
    openClawOomRecoveryTitle: '引擎内存不足，已停止自动重启',
    openClawOomRecoveryDesc: '不会删除你的聊天记录。可先打开日志排查，或清理引擎运行态后重新启动。',
    openClawOomRecoverAction: '清理会话并重新启动',
    openClawOomOpenLogsAction: '打开日志目录',
    openClawGatewayLogUnavailable: '无法打开网关日志目录',
    openClawRestartLimitTitle: '引擎连续崩溃，已停止自动重启',
    ...
    engineStartingTip4: '在设置里配置自定义模型，即可开始对话与办公任务',
    engineStartingTip5: '对 AI 说"记住……"，会写入该 Agent 的长期记忆，同一智能体下新建对话也能用到',
    ...
    openClawDataBackupBlockingTitle: '正在备份 火星 AI 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 火星 AI 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 火星 AI 数据备份？',
    ...
    coworkMemoryEnabledHint: '同一 Agent 下所有对话共享 MEMORY.md 长期记忆（OpenClaw/Codex 风格）；对话记录可分段查看。',
    ...
    coworkConfigSaveFailed: '保存 火星 AI 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: '火星 AI 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: '火星 AI 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkHomeTagline: '我是 openclow，你的全场景办公 Agent',
    ...
    myAgents: '我的 Agent',
    defaultAgentDisplayName: 'openclow',
    ...
    coworkGoalInputPlaceholder: '火星 AI 应继续朝哪个目标努力？',
    ...
    coworkErrorModelSourceWorkhorseAIPlan: '火星 AI 套餐',
    ...
    browserWebAccessDescription: '使用 火星 AI 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: '火星 AI 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription: '默认开启。关闭后仅作为 火星 AI 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: '火星 AI 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 火星 AI 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 火星 AI 可以打开此域名',
    ...
    notificationSystemPermissionHint: '若未收到通知，请在系统设置中允许 火星 AI 发送通知。',
    ...
    usageAnalyticsEnabled: '帮助改进 火星 AI',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '火星 AI 服务协议',
    privacyDialogDesc: '在使用 火星 AI 之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: '火星 AI 服务协议',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用 火星 AI',
    welcomeSubtitle: '超多AI功能等你探索～',
    welcomePromo: '配置自定义模型即可开始使用',
    welcomeLogin: '登录',
  ...
  en: {
    ...
    aiSkinCreationGuide: 'Use “Customize 火星 AI” in Expert Kits, or start here.',
    ...
    aiSkinDeleteManagedCopyNote: 'Only 火星 AI-managed skin copies are removed. Original images in the conversation and the AI Skin Designer kit are kept.',
    aiSkinDeleteFailed: 'Failed to delete the skin. Please try again.',
    uiFontSize: 'UI font size',
    uiFontSizeDescription: 'Adjust the base size used for the 火星 AI UI',
    ...
    shortcutScopeHint: 'Shortcuts only run while the 火星 AI window is focused; global shortcuts are ignored while editing text fields.',
    ...
    shortcutDescNewChat: 'Start a new 火星 AI task',
    shortcutDescFocusPrompt: 'Return to 火星 AI and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the 火星 AI task view',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Configure your own API Key in Settings, or contact an administrator.',
    ...
    artifactPreviewCardLobsterBrowser: '火星 AI Browser',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in 火星 AI Browser',
    ...
    // 火星 AI
    cowork: 'openclow',
    coworkSettings: 'openclow Settings',
    ...
    coworkWorkingDirectoryHint: '火星 AI will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for 火星 AI...',
    coworkSystemPromptHint: "Optional system prompt to customize 火星 AI's behavior",
    ...
    coworkModelSettingsHint:
      '火星 AI uses the current model and provider configuration from Model Settings.',
    ...
    modelSelectorConfigureTitle: 'Custom model required',
    modelSelectorConfigureDesc: 'Configure your own model in Settings to continue',
    modelSelectorConfigureBtn: 'Open Settings',
    ...
    openClawOomRecoveryTitle: 'Engine ran out of memory; auto-restart stopped',
    openClawOomRecoveryDesc: 'Your chat history is kept. Open logs to investigate, or clear engine runtime state and restart.',
    openClawOomRecoverAction: 'Clear sessions & restart',
    openClawOomOpenLogsAction: 'Open log folder',
    openClawGatewayLogUnavailable: 'Unable to open gateway log folder',
    openClawRestartLimitTitle: 'Engine kept crashing; auto-restart stopped',
    coworkOpenClawNotInstalledNotice:
    ...
    engineStartingTip4: 'Configure a custom model in Settings to start chatting and getting work done',
    engineStartingTip5: 'Tell AI to "remember..." and it saves facts to that Agent\'s shared long-term memory for future chats',
    ...
    openClawDataBackupBlockingTitle: 'Backing up 火星 AI data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import 火星 AI data',
    ...
    openClawDataMigrationConfirmTitle: 'Import 火星 AI data backup?',
    ...
    coworkMemoryEnabledHint:
      'All chats under the same Agent share MEMORY.md long-term memory (OpenClaw/Codex style); chat transcripts can still be listed separately.',
    ...
    coworkConfigSaveFailed: 'Failed to save 火星 AI settings. Please try again.',
    ...
    coworkPermissionDescription: '火星 AI is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: '火星 AI needs your input',
    ...
    coworkHomeTagline: "I'm openclow, your all-in-one office agent",
    ...
    coworkGoalInputPlaceholder: 'What goal should 火星 AI keep working toward?',
    ...
    coworkErrorQuotaExhausted:
      'Your credits have been used up. Please configure your own model in Settings, or contact your administrator.',
    coworkErrorFreeQuotaExhausted:
      'Your credits have been used up. Please configure your own model in Settings, or contact your administrator.',
    ...
    coworkGatewaySessionSyncTimeout:
      'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add 火星 AI to your antivirus allowlist.',
    ...
    coworkErrorModelSourceWorkhorseAIPlan: '火星 AI plan',
    ...
    browserWebAccessDescription: 'Use the 火星 AI separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription: '火星 AI starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription: 'Enabled by default. Turning it off is stored for 火星 AI, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: '火星 AI will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means 火星 AI will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means 火星 AI can open this domain',
    ...
    notificationSystemPermissionHint:
      'If you are not receiving notifications, allow 火星 AI to send notifications in the system settings.',
    ...
    usageAnalyticsEnabled: 'Help improve 火星 AI',
    ...
    // Privacy dialog
    privacyDialogTitle: '火星 AI Terms of Service',
    privacyDialogDesc:
      'Before using 火星 AI, please carefully read the {link} and confirm.',
    privacyDialogLinkText: '火星 AI Terms of Service',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to 火星 AI',
    welcomeSubtitle: 'Explore a world of AI features~',
    welcomePromo: 'Configure a custom model to get started',
    welcomeLogin: 'Login',
