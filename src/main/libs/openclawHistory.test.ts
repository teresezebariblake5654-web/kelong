  ...
  test('extracts OpenClaw 6.1 media path metadata from user messages', () => {
    expect(
      extractGatewayHistoryEntry({
        role: 'user',
        content: '[Image]\nDescription:\nA sticker.',
        MediaPath: String.raw`C:\Users\zhangsan\AppData\Roaming\Workhorse AI\openclaw\state\media\inbound\a.jpg`,
        MediaPaths: [
          String.raw`C:\Users\zhangsan\AppData\Roaming\Workhorse AI\openclaw\state\media\inbound\a.jpg`,
          String.raw`C:\Users\zhangsan\AppData\Roaming\Workhorse AI\openclaw\state\media\inbound\b.png`,
        ],
      ...
      mediaAttachments: [
        {
          localPath: String.raw`C:\Users\zhangsan\AppData\Roaming\Workhorse AI\openclaw\state\media\inbound\a.jpg`,
          mimeType: 'image/jpeg',
        },
        {
          localPath: String.raw`C:\Users\zhangsan\AppData\Roaming\Workhorse AI\openclaw\state\media\inbound\b.png`,
          mimeType: 'image/png',
        },
      ],
    });
