 ...
 *   setLanguage('en');
 *   const label = t('trayShowWindow'); // "Open 火星 AI"
...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    // Tray menu
    trayShowWindow: '打开 火星 AI',
    trayNewTask: '新建任务',
    trayViewCompletedTask: '查看完成的任务',
    trayCompletedTaskTooltip: '火星 AI - {count} 个任务已完成',
    traySettings: '设置',
    trayQuit: '退出',
    ...
    coworkGatewaySessionSyncTimeout: 'OpenClaw 引擎响应缓慢，消息尚未发送。请等待 1~2 分钟后重新发送；若频繁出现，请检查系统内存与磁盘占用，并将 火星 AI 加入杀毒软件白名单。',
    ...
    dataMigrationBackupDialogTitle: '备份 火星 AI 数据',
    dataMigrationRestoreDialogTitle: '导入 火星 AI 数据备份',
    dataMigrationBackupArchiveFilter: '火星 AI 备份包',
    dataMigrationAllFilesFilter: '所有文件',
    dataMigrationBackupBlockedByActiveWorkloads:
      '当前有正在运行的 Agent 或定时任务，请停止或等待任务完成后再备份。',
    dataMigrationRestoreProgressTitle: '正在导入 火星 AI 数据',
  ...
  en: {
    // Tray menu
    trayShowWindow: 'Open 火星 AI',
    trayNewTask: 'New Task',
    trayViewCompletedTask: 'View Completed Task',
    trayCompletedTaskTooltip: '火星 AI - {count} completed task(s)',
    ...
    coworkErrorQuotaExhausted:
      'Your credits have been used up. Please configure your own model, or contact your administrator.',
    coworkErrorFreeQuotaExhausted:
      'Your credits have been used up. Please configure your own model, or contact your administrator.',
    ...
    coworkGatewaySessionSyncTimeout: 'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add 火星 AI to your antivirus allowlist.',
    ...
    // Data migration dialogs
    dataMigrationBackupDialogTitle: 'Back Up 火星 AI Data',
    dataMigrationRestoreDialogTitle: 'Import 火星 AI Data Backup',
    dataMigrationBackupArchiveFilter: '火星 AI Backup',
    ...
    dataMigrationRestoreProgressTitle: 'Importing 火星 AI data',
    dataMigrationRestoreProgressDesc:
      'Restoring the backup and validating data. 火星 AI will restart automatically when finished.',
