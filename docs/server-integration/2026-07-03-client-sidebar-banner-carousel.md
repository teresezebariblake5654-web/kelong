...
lobsterai-server adds a public active banner list endpoint for the desktop sidebar ad slot. Workhorse AI should rotate multiple active banners and persist manual close state for the whole slot version.
