...
Real-time web search capability for Workhorse AI using Playwright-controlled browser automation.

## Overview

The Web Search Skill enables Workhorse AI to perform live web searches using Google and Bing, with automatic fallback when one provider is unavailable. The skill uses Playwright to control a local Chrome browser instance, making all operations transparent and observable.
...
This skill is part of the Workhorse AI project. For issues or suggestions:
