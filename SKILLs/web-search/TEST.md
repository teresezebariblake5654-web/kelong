...
This guide walks through testing the entire Web Search Skill integration with Workhorse AI.

## Prerequisites

1. Workhorse AI built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with Workhorse AI.

**Steps:**

1. Start Workhorse AI in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of Workhorse AI launch.
...
1. Open a terminal while Workhorse AI is running
...
**Objective:** Verify graceful shutdown of services when Workhorse AI quits.

**Steps:**

1. With Workhorse AI running and searches completed, quit the application
...
1. Start Workhorse AI (ensure headless is false in config)
...
- ✅ Server auto-starts with Workhorse AI
