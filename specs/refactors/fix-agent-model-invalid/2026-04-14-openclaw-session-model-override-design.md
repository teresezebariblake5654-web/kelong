...
- [src/renderer/components/cowork/CoworkPromptInput.tsx](/Users/yunxin/Documents/open-source/Workhorse AI/src/renderer/components/cowork/CoworkPromptInput.tsx)
...
- [src/renderer/components/cowork/CoworkView.tsx](/Users/yunxin/Documents/open-source/Workhorse AI/src/renderer/components/cowork/CoworkView.tsx)
...
Workhorse AI 的会话结构目前没有会话 override 模型字段：

- [src/renderer/types/cowork.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/renderer/types/cowork.ts)
- [src/main/coworkStore.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/main/coworkStore.ts)
...
- [src/renderer/components/cowork/CoworkView.tsx](/Users/yunxin/Documents/open-source/Workhorse AI/src/renderer/components/cowork/CoworkView.tsx)
- [src/renderer/services/cowork.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/renderer/services/cowork.ts)
- [src/main/main.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/main/main.ts)
- [src/main/libs/agentEngine/coworkEngineRouter.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/main/libs/agentEngine/coworkEngineRouter.ts)
- [src/main/libs/agentEngine/openclawRuntimeAdapter.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/main/libs/agentEngine/openclawRuntimeAdapter.ts)
...
也就是说，Workhorse AI 其实已经能稳定定位到对应的 OpenClaw session，只是没有暴露 “patch 当前 session” 这条能力。
...
4. patch 成功后同步更新 Workhorse AI 本地已持久化的 session 元数据
...
- [src/main/preload.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/main/preload.ts)
- [src/renderer/types/electron.d.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/renderer/types/electron.d.ts)
...
- [src/main/main.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/main/main.ts)
- [src/main/coworkStore.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/main/coworkStore.ts)
- [src/main/libs/agentEngine/types.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/main/libs/agentEngine/types.ts)
- [src/main/libs/agentEngine/coworkEngineRouter.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/main/libs/agentEngine/coworkEngineRouter.ts)
- [src/main/libs/agentEngine/openclawRuntimeAdapter.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/main/libs/agentEngine/openclawRuntimeAdapter.ts)

建议新增：

- [src/main/openclawSession/constants.ts](/Users/yunxin/Documents/open-source/Workhorse AI/src/main/openclawSession/constants.ts)
...
当前实现确实是“改当前 agent 的模型”，不是“改当前会话的模型”。从 OpenClaw 的现有能力看，正确方向不是继续沿用 `agentService.updateAgent()`，而是让 Workhorse AI 显式接入 `sessions.patch`，并在本地会话结构里持久化 `model_override`。
