...
Add a "prevent sleep" toggle to Settings > General tab, preventing the system from sleeping while Workhorse AI is running. Follows the existing autoLaunch pattern.

## User Story

As a user running long AI tasks or IM bots, I want Workhorse AI to prevent my computer from sleeping, so tasks aren't interrupted by the system going to sleep.
...
**Goal:** Add a "prevent sleep" toggle in Settings > General that keeps the system awake while Workhorse AI is running.
