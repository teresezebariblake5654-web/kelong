...
**New:** `https://claw.163.com/projects/dashboard/?channel=Workhorse AI#/api-keys`
...
```typescript
    const apiKeyUrl = 'https://claw.163.com/projects/dashboard/?channel=Workhorse AI#/api-keys';
```

- [ ] **Step 2: Verify the change**

Run: `grep -n 'claw.163.com/projects/dashboard' src/renderer/components/im/IMSettings.tsx`
Expected: single match at line ~569 with the new URL containing `?channel=Workhorse AI`.
