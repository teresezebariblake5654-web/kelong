...
6. Session appears in Workhorse AI sidebar
...
7. User copies API Key and pastes into Workhorse AI input field
8. User clicks Save
...
- [ ] Reply in Workhorse AI → verify email sent via SMTP/WebSocket
...
No existing Workhorse AI features are affected:
...
**Goal:** Integrate the `@clawemail/email` OpenClaw plugin into Workhorse AI with full UI configuration support for IMAP/SMTP and WebSocket transport modes.
